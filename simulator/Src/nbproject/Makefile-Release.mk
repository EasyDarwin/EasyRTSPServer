...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/easyrtspserver_demo: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/easyrtspserver_demo ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/EasyRTSPServer_Demo.o: EasyRTSPServer_Demo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EasyRTSPServer_Demo.o EasyRTSPServer_Demo.cpp

${OBJECTDIR}/getsps.o: getsps.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/getsps.o getsps.cpp
