...
BasicUsageEnvironment0::BasicUsageEnvironment0(TaskScheduler& taskScheduler, int _envirId, char *_envirName)
  : UsageEnvironment(taskScheduler, _envirId, _envirName),
...
void BasicUsageEnvironment0::appendToResultMsg(MsgString msg) {
  ...
  unsigned msgLength = (unsigned)strlen(msg);
