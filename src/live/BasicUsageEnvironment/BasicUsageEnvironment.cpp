...
BasicUsageEnvironment::BasicUsageEnvironment(TaskScheduler& taskScheduler, int _envirId, char *_envirName)
: BasicUsageEnvironment0(taskScheduler, _envirId, _envirName) {
#if defined(__WIN32__) || defined(_WIN32)
...
BasicUsageEnvironment*
BasicUsageEnvironment::createNew(TaskScheduler& taskScheduler, int _envirId, char *_envirName) {
  return new BasicUsageEnvironment(taskScheduler, _envirId, _envirName);
}
