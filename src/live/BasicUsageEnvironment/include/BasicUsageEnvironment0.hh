...
protected:
  BasicUsageEnvironment0(TaskScheduler& taskScheduler, int _envirId, char *_envirName);
...
public:
  ...
  virtual int SingleStep(unsigned maxDelayTime = 0, int threadIdx=0, char *envirName=NULL) = 0;
  ...
  int	GetId()		{return mBasicTaskSchedulerId;}
  void	SetId(int _id)	{mBasicTaskSchedulerId = _id;}
...
protected:
  ...
  int		mBasicTaskSchedulerId;		//2018.11.09
