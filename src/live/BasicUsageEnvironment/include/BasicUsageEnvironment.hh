...
public:
  static BasicUsageEnvironment* createNew(TaskScheduler& taskScheduler, int _envirId, char *_envirName);
...
protected:
  BasicUsageEnvironment(TaskScheduler& taskScheduler, int _envirId, char *_envirName);
...
public:
  static BasicTaskScheduler* createNew(int id, int maxEventNum, unsigned maxSchedulerGranularity = 10000/*microseconds*/);
...
protected:
  BasicTaskScheduler(int id, int maxEventNum, unsigned maxSchedulerGranularity);
