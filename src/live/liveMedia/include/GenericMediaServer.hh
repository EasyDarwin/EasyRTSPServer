...
public:
  ...
  void		ResetTaskFullThreadId()	{taskFullThreadId = -1;}
  int		GetTaskFullThreadId()	{return taskFullThreadId;}
...
protected:
  ...
  int						taskFullThreadId;		//任务队列已满的线程ID
...
protected:
  ...
  void		PrintAllClientSessions();		//gavin 2020.05.11
