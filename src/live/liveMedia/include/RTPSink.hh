...
public:
  ...
  void noteIncomingRR(u_int32_t SSRC, LIVE_NET_ADDRESS_SOCKADDR_IN const& lastFromAddress,
...
public:
  u_int32_t SSRC() const {return fSSRC;}
  LIVE_NET_ADDRESS_SOCKADDR_IN const& lastFromAddress() const {return fLastFromAddress;}
...
private:
  ...
  void noteIncomingRR(LIVE_NET_ADDRESS_SOCKADDR_IN const& lastFromAddress,
		      unsigned lossStats, unsigned lastPacketNumReceived,
                      unsigned jitter,
...
private:
  RTPSink& fOurRTPSink;
  u_int32_t fSSRC;
  LIVE_NET_ADDRESS_SOCKADDR_IN fLastFromAddress;
