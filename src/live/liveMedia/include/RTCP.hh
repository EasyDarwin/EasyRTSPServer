...
public:
  ...
  void setSpecificRRHandler(LIVE_NET_ADDRESS_INADDR fromAddress, Port fromPort,
  ...
  void unsetSpecificRRHandler(LIVE_NET_ADDRESS_INADDR fromAddress, Port fromPort); // equivalent to setSpecificRRHandler(..., NULL, NULL);
  ...
  void injectReport(u_int8_t const* packet, unsigned packetSize, LIVE_NET_ADDRESS_SOCKADDR_IN const& fromAddress);
...
protected:
  ...
  virtual void noteArrivingRR(LIVE_NET_ADDRESS_SOCKADDR_IN const& fromAddressAndPort,
...
private:
  ...
  void processIncomingReport(unsigned packetSize, LIVE_NET_ADDRESS_SOCKADDR_IN const& fromAddressAndPort,
			     int tcpSocketNum, unsigned char tcpStreamChannelId);
